...
public class RefreshFooter extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        addView(moreView);
        moreView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));

        moreView.measure(0, 0);

        Log.i("TAG"," getMeasuredHeight：" + moreView.getMeasuredHeight());

        mHintView = (TextView) moreView.findViewById(R.id.footer_text);
